...
```bash
sudo pip install -U git+git://github.com/Klaudia-Schulze/iqoptionapi.git

OR 

pip install -U https://github.com/Klaudia-Schulze/iqoptionapi/archive/refs/heads/master.zip
```
